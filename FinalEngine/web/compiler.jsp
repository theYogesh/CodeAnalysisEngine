...
<%! String path="D:\\EngineTest\\FinalEngine\\sandbox\\compiler\\";%>
<%! String cppName,inputName,result="testOut.txt"; %>
...
<%
    ...
    else if(request.getParameter("codeArea")==null)
    {
        ...
        CmdRunner.compileCmd(path,cppName,inputName,result);
    }
    else
    {
        cppName="Code.cpp";
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" >
                <ul class="nav navbar-nav navbar-right" id="menulist">
                    <li class="active"><a href="http://localhost:8080/FinalEngine/compiler.jsp">Compiler</a>
                    </li>
            ...
            <p>
                <div class="col-md-12">
                    <div class="col-md-6 greyBox">
                        <form action="compiler.jsp" method="post" ENCTYPE="multipart/form-data">
                            <div class="col-md-1"><h4 style="color:black;font-size:20px;font-weight: bold;">Code:-</h4></div>
                    ...
                    <div class="col-md-6 greyBox">
                        ...
                        <form class="outButton" action="DownloaderServlet">
                            <input type="hidden" name="filepath" value=<%=path%>>
                            <input type="hidden" name="filename" value="testOut.txt">
                ...
                <form action="compiler.jsp" method="post" target="_parent">
                    <div class="col-md-12">
                        <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <i class="fa fa-caret-square-o-right" aria-hidden="true" name="check"></i> Run
                            </button>
                        </div>
                    </div>
                </form>
