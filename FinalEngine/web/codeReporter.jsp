...
<%! String path="D:\\EngineTest\\FinalEngine\\sandbox\\codeReporter\\";%>
...
<%
    ...
    else if(request.getParameter("codeArea")==null)
    {
        ...
        CmdRunner.reportCmd(path, cppName, result);
    }
    else
    {
        cppName="Code.cpp";
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right" id="menulist">
                    ...
                    <li  class="active"><a href="http://localhost:8080/FinalEngine/codeReporter.jsp">Reporter</a>
                    </li>
    ...
    <div class="container">
        <div class="col-md-12 boxSection">            
            <p>
                ...
                <form action="codeReporter.jsp" method="post" target="_parent">
                    <div class="col-md-12">
                        <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="submit" class="btn btn-success margin-left-60 margin-top-30">
                                <i class="fa fa-caret-square-o-right" aria-hidden="true" name="check"></i> GenerateReport
                            </button>
